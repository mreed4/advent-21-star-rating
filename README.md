This was another fun challenge: build a simulated rating UI where a mouseover on a star highlights that star and all previous stars. Most of the code here is HTML, and most of the HTML is the SVG code. 
